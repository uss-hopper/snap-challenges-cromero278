const string = "I'll alert the crew. We finished our first sensor sweep of the neutral zone. Maybe if we felt any human loss as keenly as we feel one of those close to us, human history would be far less bloody.";

let newString = [...string].reduce((a, b)=>b+a);
...
const result = users.filter(function(index){
	return ([index.userId = 1, 2, 3, 4]);
});
console.log(result);
